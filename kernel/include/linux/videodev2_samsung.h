 ...
 * 
 * Copyright (C) 2009, Dongsoo Nathaniel Kim
 *
...
//giridhar: changing the value of V4L2_CID_RESERVED_MEM_BASE_ADDR and adding from 5 to 11
//#define V4L2_CID_RESERVED_MEM_BASE_ADDR          (V4L2_CID_PRIVATE_BASE + 5)
#define V4L2_CID_SENSOR       (V4L2_CID_PRIVATE_BASE + 5)
#define V4L2_CID_DIG_ZOOM     (V4L2_CID_PRIVATE_BASE + 6)
#define V4L2_CID_FLASH_CAMERA (V4L2_CID_PRIVATE_BASE + 7)
#define V4L2_CID_FLASH_MOVIE  (V4L2_CID_PRIVATE_BASE + 8)
#define V4L2_CID_I2C_READ     (V4L2_CID_PRIVATE_BASE + 9)
#define V4L2_CID_EXIF_DATA    (V4L2_CID_PRIVATE_BASE + 10)
#define V4L2_CID_RESERVED_MEM_BASE_ADDR          (V4L2_CID_PRIVATE_BASE + 11)
