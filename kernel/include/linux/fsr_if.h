...
*/
/**
 *  @version 	LinuStoreIII_1.2.0_b029_FSR_1.2.1_b125_RTM
...
#define LINUSTOREIII_VERSION_STRING      "LinuStoreIII_1.2.0_b029"
...
#define MAX_FLASH_PARTITIONS			((0x1 << PARTITION_BITS) - 2)	///< calculate number of partitions
