...
//giridhar
#define RESERVED_MEM_JPEG		0//(10 * 1024 * 1024)
#define RESERVED_MEM_CMM        0  
#define RESERVED_MEM_MFC		(14 * 1024 * 1024)
#define RESERVED_PMEM_JPEG      (3 * 1024 * 1024)
#define RESERVED_PMEM_RENDER    (2 * 1024 * 1024)
#define RESERVED_PMEM_STREAM    (0)
#define MEM_G3D_SHARED			(RESERVED_MEM_FIMC0 + RESERVED_MEM_FIMC1 + RESERVED_MEM_FIMC2 + RESERVED_MEM_CMM + RESERVED_MEM_MFC + RESERVED_PMEM_JPEG + RESERVED_PMEM_STREAM +RESERVED_PMEM_RENDER)
#define RESERVED_MEM_G3D_UI     (6 * 1024 * 1024)
#define RESERVED_MEM_G3D 		(44 * 1024 * 1024) //(30 * 1024 * 1024) // MEM_G3D_SHARED + RESERVED_MEM_G3D_UI + alpha ( It should be over 24MB)
//#define RESERVED_MEM_G3D		(MEM_G3D_SHARED > (24 * 1024 * 1024)) ? MEM_G3D_SHARED: (24 * 1024 * 1024)
...
#define RESERVED_PMEM_PICTURE	(1 * 1024 * 1024) // PMEM_PIC and MFC can be shared, but this time is not

#define RESERVED_PMEM_PREVIEW   (2 * 1024 * 1024) // FIMC0 buffers are directly used for rendering.
...
#define SKIA_RESERVED_PMEM_START        (STREAM_RESERVED_PMEM_START - RESERVED_PMEM_SKIA)
#define G3D_RESERVED_MEM_START          (SKIA_RESERVED_PMEM_START - RESERVED_MEM_G3D) //SHARED MEMORY
...
#define PICTURE_RESERVED_PMEM_START     (RESERVED_PMEM_START - RESERVED_PMEM_PICTURE)
#define PHYS_UNRESERVED_SIZE            (PICTURE_RESERVED_PMEM_START - PHYS_OFFSET_ONEDRAM)
