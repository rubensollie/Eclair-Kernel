...
#define S3C_MAX_ENDPOINTS	15 //0 ~ 15
...
enum gadget_driver {
	...
	ANDROID_ADB_UMS,
	ANDROID_ADB_UMS_ACM,
	ANDROID_ADB_UMS_ACM_ETH,
	ANDROID_ADB_UMS_ACM_ETH_CDC,
	ANDROID_ADB_UMS_ACM_ETH_RNDIS,
	ANDROID_ADB_UMS_ACM_ETH_RNDIS_MTP,
	SERIAL,
	CDC2,
	FILE_STORAGE,
};
...
struct s3c_udc {
	...
	struct s3c_ep ep[S3C_MAX_ENDPOINTS+1]; //from 0 to S3C_MAX_ENDPOINTS
