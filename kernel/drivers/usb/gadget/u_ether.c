...
/* 
 * Changing qmult 5 to 1 to reduce time for freeing pre-allocated request
 * makes RNDIS passing on USB CV ch9 test
 * If qmult of 5 , RNDIS couldn't respond on time by USB CV ch9 test scenario's responding time
 * Decreasing qmult could decrease the throughput of network
 */ 
//static unsigned qmult = 5;
static unsigned qmult = 1;
