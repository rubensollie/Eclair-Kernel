...
//#define LCD_SDI_DATA	gpio_get_value(GPIO_DISPLAY_SI)
//#define LCD_SDI_SWITCH_INPUT		gpio_direction_input(GPIO_DISPLAY_SI);
//#define LCD_SDI_SWITCH_OUTPUT_LOW	gpio_direction_output(GPIO_DISPLAY_SI, 0);
//#define LCD_SDI_SWITCH_OUTPUT_HIGH	gpio_direction_output(GPIO_DISPLAY_SI, 1);
