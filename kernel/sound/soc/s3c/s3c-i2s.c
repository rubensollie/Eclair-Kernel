 ...
 *
 * (c) 2009 Samsung Electronics   - Jaswinder Singh Brar
...
// begin : CONFIG_SND_UNIVERSAL_WM8994_MASTER
		...
		clk_enable(clk);
		clk_put(clk);
// end : CONFIG_SND_UNIVERSAL_WM8994_MASTER
			     ...
			     struct snd_soc_dai *dai)
{
	...
	clk_put(cn);
#endif    // CONFIG_SND_UNIVERSAL_WM8994_MASTER
...
#ifdef USE_CLKAUDIO
lb:	
	clk_put(cf);    // CONFIG_SND_UNIVERSAL_WM8994_MASTER
lb1:
	clk_put(cm);
lb2:
